...
flights_data = spark.read.json("gs://louie-etl/json/2019-04-27.json")
...
output_flight_nums = "gs://louie-etl/output/" + file_name + "_flight_nums"
output_distance_category = "gs://louie-etl/output/" + file_name + "_distance_category"
