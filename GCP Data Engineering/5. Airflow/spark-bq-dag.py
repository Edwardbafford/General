...
# project specifics
BUCKET = "gs://louie-etl"
PROJECT_ID = "semiotic-tracer-252319"
...
with DAG("flights_delay_etl",default_args=DEFAULT_DAG_ARGS) as dag : 
    ...
    bq_load_delays_by_flight_nums = GoogleCloudStorageToBigQueryOperator(
        ...
        bucket=BUCKET,
        source_objects=["output/"+current_date+"_flight_nums/part-*"],
    ...
    delete_tranformed_files = BashOperator(
        ...
        bash_command = "gsutil -m rm -r " +BUCKET + "/output/*"
    )
